...
public class OrmmaUtilityController extends OrmmaController {
	 ...
	 */
	public OrmmaUtilityController(AdViewCore adView, Context context) {
	...
	public void init(float density) {
		String injection = "window.ormmaview.fireChangeEvent({ state: \'default\'," + " network: \'"
				...
				+ (int) (mAdViewCore.getLeft() / density) + ", y: " + (int) (mAdViewCore.getTop() / density)
				+ ", width: " + (int) (mAdViewCore.getWidth() / density) + ", height: "
				+ (int) (mAdViewCore.getHeight() / density) + " }," + " orientation:"
				+ mDisplayController.getOrientation() + "," + getSupports() + " });";
        Log.d(LOG_TAG, "init: injection: " + injection);
		mAdViewCore.injectJavaScript(injection);
	 ...
	 */
	public void ready() {
		mAdViewCore.injectJavaScript("Ormma.setState(\"" + mAdViewCore.getState() + "\");");
		mAdViewCore.injectJavaScript("ORMMAReady();");
	}
	...
	public void makeCall(String number) {
		...
		if (url == null) {
			mAdViewCore.raiseError("Bad Phone Number","makeCall");
		}
		else{
