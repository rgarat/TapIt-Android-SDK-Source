...
import com.tapit.adview.ormma.util.NavigationStringEnum;
import com.tapit.adview.ormma.util.TransitionStringEnum;
...
public abstract class OrmmaController {
	...
	protected AdViewCore mAdViewCore;
	//context it is in
	 ...
	 */
	public OrmmaController(AdViewCore adView, Context context) {
		mAdViewCore = adView;
		mContext = context;
	}
